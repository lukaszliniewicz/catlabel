...
export default function ShippingLabelModal({ onClose }) {
  ...
  const handleGenerate = () => {
    ...
    newItems.push({
      ...
      text: `FROM:\n${fLines.join('\n')}`, 
      x: 16, y: 16, size: 16, weight: 700, font: 'Roboto.ttf',
    ...
    newItems.push({
      ...
      text: `SHIP TO:`, 
      x: 16, y: 130, size: 20, weight: 700, font: 'Roboto.ttf',
    ...
    newItems.push({
      ...
      x: 16, y: 170, size: 60, weight: 700, font: 'Roboto.ttf',
    ...
    newItems.push({
      ...
      text: tLines.join('\n'), 
      x: 16, y: 240, size: 32, weight: 700, font: 'Roboto.ttf',
    ...
    if (hasCustomText) {
      ...
      newItems.push({
        ...
        x: 16, y: targetH - 32, size: 20, weight: 700, font: 'Roboto.ttf',
