...
_DEFINITIONS = {
    ...
    ProtocolFamily.PHOMEMO_M: ProtocolDefinition(
        spec=ProtocolSpec(
            packet_prefix=b"",
            command_set=ProtocolCommandSet.LEGACY,
            transport_style=ProtocolTransportStyle.STANDARD,
    ...
    ProtocolFamily.PHOMEMO_M02: ProtocolDefinition(
        spec=ProtocolSpec(
            packet_prefix=b"",
            command_set=ProtocolCommandSet.LEGACY,
            transport_style=ProtocolTransportStyle.STANDARD,
    ...
    ProtocolFamily.PHOMEMO_M04: ProtocolDefinition(
        spec=ProtocolSpec(
            packet_prefix=b"",
            command_set=ProtocolCommandSet.LEGACY,
            transport_style=ProtocolTransportStyle.STANDARD,
    ...
    ProtocolFamily.PHOMEMO_M110: ProtocolDefinition(
        spec=ProtocolSpec(
            packet_prefix=b"",
            command_set=ProtocolCommandSet.LEGACY,
            transport_style=ProtocolTransportStyle.STANDARD,
    ...
    ProtocolFamily.PHOMEMO_D: ProtocolDefinition(
        spec=ProtocolSpec(
            packet_prefix=b"",
            command_set=ProtocolCommandSet.LEGACY,
            transport_style=ProtocolTransportStyle.STANDARD,
    ...
    ProtocolFamily.PHOMEMO_P12: ProtocolDefinition(
        spec=ProtocolSpec(
            packet_prefix=b"",
            command_set=ProtocolCommandSet.LEGACY,
            transport_style=ProtocolTransportStyle.STANDARD,
